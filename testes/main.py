...
def main():
    ...
    # Fazer uma cópia dos dados originais e permutar
    df_permutado = df_original.copy()
    shuffle(df_permutado.values)  # Permutação dos valores inplace
    df_permutado.reset_index(drop=True, inplace=True)  # Resetar índices

    # Calcular e plotar análises para os dados permutados
    calcular_e_plotar_analises(df_permutado)
